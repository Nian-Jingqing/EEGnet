...
if isempty(dir([curr_dir filesep 'EEG_Features' filesep 'Rev_' dataset_name '_Epoch*.mat']))
    already_computed = false;
else
    already_computed = true;
end
if already_computed already_computed_feats = whos('-file',[curr_dir filesep 'EEG_Features' filesep 'Rev_' dataset_name '_Epoch1.mat']); else  already_computed_feats = []; already_computed_feats.name = ''; end
